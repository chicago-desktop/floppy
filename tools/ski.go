...
func main() {
 ...
 err=wapp.NewWriter().Pack(wapp.Metadata{"name":"Ski — Downhill Adventures"},[]wapp.Entry{{ID:wapp.NewID("ski","game"),Kind:"function.lua",Meta:wapp.Metadata{"title":"Ski", "floppy_window":"canvas.v1"},Data:map[string]any{"source":string(source),"method":"main"}}},files,wapp.NewID("ski","files"),nil,out)
